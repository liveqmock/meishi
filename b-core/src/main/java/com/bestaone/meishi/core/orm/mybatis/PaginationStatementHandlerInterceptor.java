package com.bestaone.meishi.core.orm.mybatis;
...
import com.bestaone.meishi.core.orm.dialect.Dialect;
import com.bestaone.meishi.core.orm.dialect.DialectFactory;
...
public class PaginationStatementHandlerInterceptor implements Interceptor{
	...
	private long getTotal(ParameterHandler parameterHandler, Connection connection, String countSql) throws Exception {
		//MetaObject metaStatementHandler = MetaObject.forObject(parameterHandler);
		//Object parameterObject = metaStatementHandler.getValue("parameterObject");
