...
<body>
			...
			<div class="container">
				...
				<div class="nav-collapse collapse">
					...
					<form class="navbar-form pull-right">
					    <div class="input-prepend input-append mb5">
						    <div class="btn-group">
							    <button class="btn dropdown-toggle" data-toggle="dropdown">所有<span class="caret"></span></button>
							    <ul class="dropdown-menu">
									<li><a tabindex="-1" href="#">店名</a></li>
									<li><a tabindex="-1" href="#">电话号码</a></li>
									<li><a tabindex="-1" href="#">地址</a></li>
									<li class="divider"></li>
									<li><a tabindex="-1" href="#">开业时间</a></li>
							    </ul>
						    </div>
						    <input class="span2" id="appendedPrependedDropdownButton" placeholder="店名、电话、地址..." type="text">
	...
	<section class="container">
		...
		<header>
			<div class="hero-unit banle" style=" background:url(/static/img/banner1.jpg);">
				<h2>你好, 欢迎来到爱玩网!</h2>
				<p>This is a template for a simple marketing or informational website. It includes a large callout called the hero unit and three supporting pieces of content. Use it as a starting point to create something more unique.</p>
				<p><a href="#" class="btn btn-primary btn-large">了解更多 »</a></p>			
			</div>
		</header>
		
		<section class="cb">
			<article class="mainArticle fl">
...
<dl>
    ...
    <dd>
        <a class="checkout3" target="_blank" href="/product-153579.html">去看看</a>¥38 <del title="¥99">¥99</del>
			...
			<aside class="mainAside fl clearfix">
				<div id="map" class="modebox baidu-map map4"></div>
				<div class="modebox">地图</div>	
			</aside>
		</section>
		<footer class="text-center cb">
			<hr>
			<ul>
